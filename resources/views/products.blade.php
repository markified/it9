        ...
        <div class="flex-1 p-6">
            <div class="container mx-auto py-10">
                <div class="text-center mb-10">
                    <h1 class="text-4xl font-bold text-gray-800">Computer Products</h1>
                </div>
                <div class="mb-6">
                    <ul class="flex space-x-4">
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('processors')">Processors</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('graphics-cards')">Graphics Cards</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('storage')">Storage</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('motherboard')">Motherboard</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('ram')">RAM</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('power-supply')">Power Supply</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('fans')">Fans</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('monitors')">Monitors</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('case')">Case</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('mouse-keyboards')">Mouse and Keyboards</a></li>
                        <li><a href="#" class="text-blue-500 hover:underline" onclick="toggleCategory('others')">Others</a></li>
                    </ul>
                </div>
